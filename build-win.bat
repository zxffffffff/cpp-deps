...
echo "[1-1] cmake %deps_zlib% -G %generators%  -DCMAKE_INSTALL_PREFIX=%install_zlib2%"
cmake %deps_zlib% -G %generators%  -DCMAKE_INSTALL_PREFIX=%install_zlib2%
...
echo "[1-2] cmake %deps_protobuf% -G %generators% -DCMAKE_INSTALL_PREFIX=%install_protobuf2% -Dprotobuf_BUILD_TESTS=OFF"
cmake %deps_protobuf% -G %generators% -DCMAKE_INSTALL_PREFIX=%install_protobuf2% -Dprotobuf_BUILD_TESTS=OFF
